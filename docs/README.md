...
| TypeScript   | 1.2 年   | 状況に応じてコーディングができる |
...
- フロントエンド、バックエンドに関しては、更に知識を深めつつサービスを作るうえで必要なインフラ周りや長期を見据えたサービス運用ができるようになりたいです
  - より多く知識や経験を積み、ユーザーにとって最善な提案やサービスを提供できるようになりたいため
- 興味がある分野は、医療・子育て関連です
  - 約 2 年程診療所にて医療事務、医師事務作業補助として勤務していたため医療用語などの抵抗はありません
