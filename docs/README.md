...
| JavaScript   | 1.8 年   | 状況に応じてコーディングができる |
| TypeScript   | 3 ヶ月   | 状況に応じてコーディングができる |
| Ruby         | 1.1 年   | 状況に応じてコーディングができる |
| HTML5        | 2 年     | 簡単なマークアップができる       |
| CSS・Scss    | 1.5 年   | 簡単なマークアップができる       |
...
| 名称                         | 経験年数 | 習熟度・説明                     |
| ---------------------------- | -------- | -------------------------------- |
| Nuxt.js(2.x)                 | 1.4 年   | 状況に応じてコーディングができる |
...
| MySQL(5.x)                   | 1.5 年   | テーブル設計・CRUD の操作が可能  |
...
- 2018-12-04 [「会社には共感していますが、依存しすぎないようにしています」井上奈々（株式会社 diffeasy）〜Forkwell エンジニア成分研究所 - Forkwell Press ](https://pr.forkwell.com/2018-12-04-engineer_component/)
...
- 興味がある分野は、医療・農業・子育て関連です。医療に関しては、2 年くらい診療所にて医療事務、医師事務作業補助として勤務していたのでその時の知識を活かせれば嬉しいです。農業に関しては、情報を収集している段階ですがシステムの力で農業の方々を助けることができたらいいなと思います。子育てに関しては、保育園のアナログな状況を少しでも改善できたらいいなと思ったりしています。
